...
export function BalanceSummary({ totalIn, totalOut }: { totalIn: number; totalOut: number }) {
  ...
  return (
    <div className="hero-surface relative overflow-hidden rounded-[var(--radius)] p-5 shadow-[var(--shadow)]">
      <p className="text-sm text-white/70">Net this month</p>
      <p className="mt-1 text-[2.5rem] font-semibold leading-none tracking-tight">
        {net >= 0 ? "" : "−"}
